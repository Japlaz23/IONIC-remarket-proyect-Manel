  ...
  const chats = ref<ChatThread[]>([
    {
      ...
      messages: [
        ...
        },
        {
          ...
          senderId: 2,
          senderName: 'Juan Pérez',
          text: 'Tengo cerca el centro comercial, ¿te va bien ahí?',
        ...
        },
        {
          ...
          senderId: 1,
          senderName: 'Tú',
          text: 'Sí, perfecto. ¿Qué tal mañana a las 6pm?',
          timestamp: new Date('2026-02-17T10:51:00'),
          read: false,
        },
        {
          id: 13,
          ...
          senderId: 2,
          senderName: 'Juan Pérez',
          text: 'Mañana a las 6pm me va genial, nos vemos entonces!',
          timestamp: new Date('2026-02-17T10:52:00'),
          read: false,
        }
      ],
    },
    ...
    },
    {
      ...
      messages: [
        ...
        },
        {
          ...
          senderId: 999,
          senderName: 'Soporte ReMarket',
          text: 'Si tienes alguna pregunta o necesitas asistencia, no dudes en contactarnos',
          timestamp: new Date('2026-02-15T12:00:00'),
          read: true,
        }
      ],
